...
public class WBShareActivity extends Activity implements OnClickListener, WbShareCallback {
    ...
    public void onClick(View v) {
        if (R.id.share_to_btn == v.getId()) {
            ...
            flag = 1;
            sendMessage(false,mImageCheckbox.isChecked());
        }
    }
    ...
    private MultiImageObject getMultiImageObject(){
       ...
       if(!WbSdk.supportMultiImage(this)) {
            Toast.makeText(this,"该版本不支持分享多张图片",Toast.LENGTH_SHORT).show();
       }
        ...
        pathList.add(Uri.parse("http://img1.imgtn.bdimg.com/it/u=4073425408,760969153&fm=27&gp=0.jpg"));
        pathList.add(Uri.parse("http://img3.imgtn.bdimg.com/it/u=3059607941,393199546&fm=27&gp=0.jpg"));
        pathList.add(Uri.parse("http://img2.imgtn.bdimg.com/it/u=2760227068,2010392660&fm=27&gp=0.jpg"));
...
//        MediaRecorder.VideoSource w = new
        //获取视频
        VideoSourceObject videoSourceObject = new VideoSourceObject();
        videoSourceObject.videoPath = Uri.fromFile(new File(getExternalFilesDir(null)+"/eeee.mp4"));
        //videoSourceObject.videoPath =  Uri.parse("http://jzvd.nathen.cn/6ea7357bc3fa4658b29b7933ba575008/fbbba953374248eb913cb1408dc61d85-5287d2089db37e62345123a1be272f8b.mp4");
//        videoSourceObject.videoPath =  Uri.parse("http://jzvd.nathen.cn/6ea7357bc3fa4658b29b7933ba575008/fbbba953374248eb913cb1408dc61d85-5287d2089db37e62345123a1be272f8b.mp4");
